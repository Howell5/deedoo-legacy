...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-widgets': { kind: 'none', reason: 'Browser-side Widget application container; registers nothing model-facing.' },
  ...
  'packages/widget/widgets': { kind: 'none', reason: 'Human-facing local application service; registers nothing model-facing.' },
  'packages/widget/widgets-local': { kind: 'indirect', reason: 'Created starter instructions enter model context through the Workspace instruction loader.' },
