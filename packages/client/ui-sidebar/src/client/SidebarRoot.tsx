 ...
 * and the foot holds `sidebar.application`, `sidebar.footer.action`, and
 * `sidebar.settings`; the shell
  ...
  return (
    ...
    >
      ...
      <div className={css.footArea}>
        <div className={css.applicationArea}>
          {renderSlot('sidebar.application', { wide })}
        </div>
